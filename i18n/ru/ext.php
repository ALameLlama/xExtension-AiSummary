...
return [
	'ai_summary' => [
		...
		'reasoning_effort' => 'Усиление рассуждения',
		'reasoning_effort_none' => 'Без',
		'reasoning_effort_low' => 'Низкое',
		'reasoning_effort_high' => 'Высокое',
		'reasoning_effort_help' => 'Контролирует, насколько глубоко модель рассуждает перед ответом. Более высокий уровень использует больше токенов и времени, но может дать лучшие результаты. Доступно только для определённых моделей.',
		'save' => 'Сохранить',
	],
];
